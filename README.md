...
<strong>
Niantic has forced minimum version of Pokebot clients to 0.39. 

Do not attempt to connect with any bot or else you will be flagged as a bot since all bots use the 0.35 API and real apps use 0.39 API.
</strong>
